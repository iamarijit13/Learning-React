...
// This is the starting poing of timestamp.
// i.e. 333440 means, it is after 33440 ms after the starting point. similarly -345434 is before starting point.
...
const expenseOne = store.dispatch(addExpense({ description: 'Rent', amount: '300', createdAt: -12000}));
